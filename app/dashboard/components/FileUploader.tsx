  ...
  return (
    <div className="bg-white rounded-xl shadow-md p-6 border border-gray-200">
      <div className="flex items-center gap-2 mb-4">
        ...
        <div>
          <h2 className="text-lg font-semibold text-gray-900">Upload your intake or documents</h2>
          <p className="text-xs text-gray-500 mt-1">Drop a file or click to upload. For the demo you can use sample or fake information.</p>
          <p className="text-xs text-gray-400 mt-1">Remove names/personal details for privacy.</p>
        </div>
      </div>
